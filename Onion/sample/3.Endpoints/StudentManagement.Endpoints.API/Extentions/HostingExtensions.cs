...
using StudentManagement.Endpoints.API.CustomDecorators;
...
public static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        //CommandDbContext
        builder.Services.AddDbContext<StudentManagementCommandDbContext>(
        ...
        //QueryDbContext
        builder.Services.AddDbContext<StudentManagementQueryDbContext>(
