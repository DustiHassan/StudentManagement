using StudentManagement.Endpoints.API.Extentions.DependencyInjection.IdentityServer.Options;

namespace StudentManagement.Endpoints.API.Extentions.DependencyInjection.IdentityServer.Extentions;
